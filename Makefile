...
FLAGS= -L/usr/local/cuda/lib64 -I/usr/local/cuda-11.5/targets/x86_64-linux/include -lcuda -lcudart
ANIMLIBS= -lglut -lGL


all: interface.o gpuCode.o animate.o hostCode.o
	g++ -o viruSim interface.o gpuCode.o hostCode.o animate.o $(FLAGS) $(ANIMLIBS)
